...
multiple network attachments to choose between or to use simultaneously, or 
could handle pools of multiple connections, such scenarios are out of scope 
for the working group deliverables.
